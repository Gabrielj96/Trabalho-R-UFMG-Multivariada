...
Segundo o critério de Kaiser, talvez a análise fatorial não seja adequada para esses dados já que o teste retornou MSA = 0.24, ou seja, um número baixo significa que as variáveis analisadas não apresentam correlações fortes o suficiente para serem agrupadas em fatores.
