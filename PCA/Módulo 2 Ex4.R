...
sink(file = '_out/output/PCA_SANEAMENTO.txt')
print(summary(PCA))
cat('\n PCA loadings: \n')
print(PCA$loadings[])
sink()
...
dev.print(file = '_out/figures/figScreePlot_SANEAMENTO.png',
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figMap_PCA_SANEAMENTO.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
PCA$loadings[]
# salvando os resultados em um arquivo de texto
sink(file = '_out/output/PCA_MORADIA.txt')
print(summary(PCA))
cat('\n PCA loadings: \n')
print(PCA$loadings[])
sink()
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figScreePlot_MORADIA.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figMap_PCA_MORADIA.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
PCA$loadings[]
# salvando os resultados em um arquivo de texto
sink(file = '_out/output/PCA_EMPREGO.txt')
print(summary(PCA))
cat('\n PCA loadings: \n')
print(PCA$loadings[])
sink()
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figScreePlot_EMPREGO.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figMap_PCA_EMPREGO.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
PCA$loadings[]
# salvando os resultados em um arquivo de texto
sink(file = '_out/output/PCA_EDUCACAO.txt')
print(summary(PCA))
cat('\n PCA loadings: \n')
print(PCA$loadings[])
sink()
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figScreePlot_EDUCACAO.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figMap_PCA_EDUCACAO.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
PCA$loadings[]
# salvando os resultados em um arquivo de texto
sink(file = '_out/output/PCA_TODOS.txt')
print(summary(PCA))
cat('\n PCA loadings: \n')
print(PCA$loadings[])
sink()
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figScreePlot_TODOS.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
...
# salvando em arquivo [caixa quadrada] (png)
c.width = 1; c.height = 1; c.res = 1.4
dev.print(file = '_out/figures/figMap_PCA_TODOS.png',
          device = png, width = 1280*c.width, height = 720*c.height, res = 96*c.res, units = 'px')
